      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* AI Scam Guard Inspector Quick Trigger */}
            <button
              onClick={() => setIsScamGuardModalOpen(true)}
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white border border-slate-200 rounded-xl shadow-xl py-2 z-50 text-xs">
                  <div className="px-3 py-2 border-b border-slate-100">
                    ...
                    <div className="mt-1 flex items-center gap-1.5 text-emerald-600 text-[10px] font-medium">
                      <CheckCircle2 className="w-3 h-3" />
                      <span>2FA Protected & Identity Verified</span>
                    </div>
                  </div>
